...
public class StudentOutputDtoWithSubjects {
    ...
    public StudentOutputDtoWithSubjects(Student student){
        ...
        List<StudentSubjectOutputDto> subjectsOutputDto = student.getStudentSubjects() != null ?
                student.getStudentSubjects().stream().map(StudentSubjectOutputDto::new).collect(Collectors.toList()) :
                null;
